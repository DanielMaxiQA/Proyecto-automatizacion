...
class TestReportAgentAR:
    ...
    async def test_report_agent_ar(self, logged_in_browser, page):
        ...
        with allure.step("Seleccionar reportes Agent A/R"):
            ...
            await take_screenshot(page, "Reportes Agent A/R")
            ...
            expect(agent_ar_page.abrir_en_nueva_pestana_button).to_be_enabled(timeout=80000)
            await agent_ar_page.click_test()
            time.sleep(2)
